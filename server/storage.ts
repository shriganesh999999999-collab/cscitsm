  ...
  public seedInitialData() {
    ...
    const depts: Department[] = [
      ...
      },
      {
        ...
        requiresDualApproval: true,
        approvalChannels: ['EMAIL', 'WHATSAPP'],
        description: 'Cloud Infrastructure, CSCSPV & SDC Management',
      },
      {
        id: 'dept-2',
        code: 'CYBER',
    ...
    // 2. Locations
    const locs: Location[] = [
      { id: 'loc-1', code: 'NDC-DEL', name: 'CSCSPV', city: 'New Delhi', state: 'Delhi', isDC: true },
    ...
    this.notificationTemplates = [
      {
        ...
        channel: 'EMAIL',
        subjectTemplate: '[CSCSPV] Ticket {{ticket_number}} Created - {{subject}}',
      ...
      },
      {
        ...
        channel: 'WHATSAPP',
        bodyTemplate: 'CSCSPV: Ticket {{ticket_number}} (Priority: {{priority}}) has been assigned to you for investigation. Please review in Service Portal.',
        isActive: true,
      },
      {
        id: 'nt-3',
        ...
        channel: 'EMAIL',
        subjectTemplate: '[CSCSPV] Ticket {{ticket_number}} Resolved - Action Required',
    ...
    this.serviceCatalog = [
      ...
      },
      {
        ...
        approvalStages: ['CISO Approval (WhatsApp/Email)', 'Infra Head Approval (WhatsApp/Email)', 'Operations Manager Assignment'],
        fields: [
          { id: 'subnets', label: 'Destination Data Centre / Subnets', type: 'select', options: ['CSCSPV (New Delhi)', 'State Data Centre (SDC Hyderabad)', 'Regional Operations Subnets', 'All Enterprise Zones (Full Tunnel)'], required: true },
    ...
    const sampleAccessReqs: AccessRequest[] = [
      ...
      },
      {
        ...
        departmentName: 'Cloud Infrastructure & DC',
        applicationName: 'CSCSPV Perimeter Firewall',
        environment: 'PRODUCTION',
        accessType: 'ADMIN',
    ...
    this.addAuditLog({
      ...
      newValue: 'Initialized CSCSPV Database Schema with ISO 27001 Controls',
